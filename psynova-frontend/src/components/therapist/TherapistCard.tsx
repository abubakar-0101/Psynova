...
export function TherapistCard({ therapist }: TherapistCardProps) {
  ...
  return (
    <motion.div
      ...
      className="group relative rounded-3xl border border-[var(--border-subtle)] bg-[var(--surface)] p-5 transition-all duration-200 hover:border-[var(--brand-accent)]/30 hover:shadow-[0_20px_60px_-20px_rgba(99,102,241,0.25)]"
    >
